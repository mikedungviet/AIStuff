...
{	
	...
	m_BossFlameAnimation = setAnimation("flame.png", 8, 3, 1920, 500, 0.1f);
	cocos2d::AnimationCache::getInstance()->addAnimation(m_BossFlameAnimation, "boss_flame_animation_key");

	m_BossSpitAnimation = setAnimation("fire_ball.png", 12, 70, 70, 0.1f);
	cocos2d::AnimationCache::getInstance()->addAnimation(m_BossSpitAnimation, "boss_spit_animation_key");

	m_BossSpitTellAnimation = setAnimation("boss_projectile_attack.png", 23, 500, 1300, 0.1f);
